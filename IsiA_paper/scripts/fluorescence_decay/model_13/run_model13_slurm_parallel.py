...
For single node: python3 run_model13_slurm_parallel.py 0
For multi-node: srun python3 run_model13_slurm_parallel.py $SLURM_PROCID
...
# Configuration
script_name = "run_model_13.py"
config_name = os.environ.get('ENSEMBLE_CONFIG', 'model_13')
...
if __name__ == '__main__':
    print("\n" + "="*70)
    print("IsiA Model 13 - SLURM Parallel Ensemble Runner")
    print("="*70)
