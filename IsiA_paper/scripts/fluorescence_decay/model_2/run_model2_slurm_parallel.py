...
For single node: python3 run_model2_slurm_parallel.py 0
For multi-node: srun python3 run_model2_slurm_parallel.py $SLURM_PROCID
...
config_name = os.environ.get('ENSEMBLE_CONFIG', 'model_2')
